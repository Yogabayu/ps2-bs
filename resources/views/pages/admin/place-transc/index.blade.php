...
@section('title', 'Tempat Transaksi')
            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('place-transc.create') }}">
                                    <button class="btn btn-primary my-3">
                                        <i class="fas fa-add"></i> Tambah Tempat Transaksi
                                    </button>
                                </a>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('place-transc.edit', $data->id) }}"
                                                            class="btn btn-info btn-sm" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>

                                                        <button class="btn btn-danger btn-sm" title="Delete"
                                                            onclick="confirmDelete('{{ route('place-transc.destroy', $data->id) }}')">
